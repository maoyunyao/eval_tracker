from evaluation import EvalLaSOT
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Draw success and precision plot on LaSOT dataset.')
    ...
    ##############################################################
    trackers = {}
    trackers["ATOM"] = {"path": "/data5/maoyy/eval_tracker/eval_lasot/Results/ATOM", "repeat": True}
