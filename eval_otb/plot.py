from evaluation import EvalOTB
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Draw success and precision plot on OTB dataset.')
    ...
    ##############################################################
    trackers = {}
    trackers["ATOM"] = {"path": "/data5/maoyy/eval_tracker/eval_otb/Results/ATOM", "repeat": True}
